angular.module('investitNavBarApp', [ 'ngMaterial', 'ngImgCrop' ]);
/*----------------------------------------------------------------------------------------------------*/
/**
 * Directive
 */
angular
		.module('investitNavBarApp')
		.directive(
				'investitNavBar',
				[
						'loadNavbar',
						...
						function(loadNavbar, $timeout) {
							return {
								restrict : 'E',
								templateUrl : '/views/core/investit-nav-bar/templates/investit-nav-bar.html',
								transclude : true,
								scope : {
									initialSelectedItem : '@',
								},
 ...
 * Configuration
 */
angular.module('investitNavBarApp').config(
		[
				'$mdThemingProvider',
				'$mdIconProvider',
 ...
 * Services
 */
angular.module('investitNavBarApp').factory('loadNavbar',
...
angular.module('investitNavBarApp').factory('saveUserAvatar',
...
angular.module('investitNavBarApp').factory('investitLogout',
...
angular.module('investitNavBarApp').factory('avatarDialog',
 ...
 * Menu toggle
 */
angular.module('investitNavBarApp').directive('investitNavbarMenuToggle', [ function() {
	return {
		scope : {
			item : '=',
		},
		require : '^^investitNavBar',
		templateUrl : '/views/core/investit-nav-bar/templates/menu-toggle.html',
		...
		.directive(
				...
				[ function() {
					return {
						...
						require : '^^investitNavBar',
						templateUrl : '/views/core/investit-nav-bar/templates/menu-link.html',
						link : function(scope, element, attr, parentController) {
							scope.globalAttr = globalAttr;
						}
					};
...
angular
		...
		.directive(
				'investitToolbarMenu',
				[ 'investitLogout', 'saveUserAvatar', 'avatarDialog', function(investitLogout, saveUserAvatar, avatarDialog) {
					return {
						scope : {
							
						},
						templateUrl : '/views/core/investit-nav-bar/templates/toolbar-menu.html',
						link : function(scope, element, attr) {
							scope.globalAttr = globalAttr;
							var avatars = ['/views/core/investit-nav-bar/images/male-avatar.svg', '/views/core/investit-nav-bar/images/female-avatar.svg'];
							/*----------------------------------------------------------------------------------------------------*/
							...
							/*----------------------------------------------------------------------------------------------------*/
							scope.investitLogout = function(){
								investitLogout(scope.sessionToken);
							}
							/*----------------------------------------------------------------------------------------------------*/
