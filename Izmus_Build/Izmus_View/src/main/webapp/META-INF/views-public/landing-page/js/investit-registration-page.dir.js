angular
		...
		.directive(
				'investitRegistrationPage',
				[
						'investitRegistration',
						'checkUserAndEmail',
						'$mdToast',
						function(investitRegistration, checkUserAndEmail, $mdToast) {
							return {
								restrict : 'E',
												...
												checkUserAndEmail($scope.userName,
														$scope.email).then(function(response){
															if (response.isEmailExists == true && response.isUserExists == true){
																...
																investitRegistration($scope.userName,
																		$scope.email);
															}
														});
											}
...
angular.module('investitLandingPageApp').controller('registrationToastCtrl', ['$scope','message', function($scope, message){
