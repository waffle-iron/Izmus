...
public class InvestITPermissionEvaluator implements PermissionEvaluator, Filter,
WebInvocationPrivilegeEvaluator{
	/*----------------------------------------------------------------------------------------------------*/
	private static final Logger LOGGER = LoggerFactory.getLogger(InvestITPermissionEvaluator.class);
