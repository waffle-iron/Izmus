...
@Component("InvestITAuthenticationProvider")
public class InvestITAuthenticationProvider implements AuthenticationProvider {
	/*----------------------------------------------------------------------------------------------------*/
	private static final Logger LOGGER = LoggerFactory.getLogger(InvestITAuthenticationProvider.class);
	@Autowired
